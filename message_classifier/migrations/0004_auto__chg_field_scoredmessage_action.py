...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScoredMessage.action'
        db.alter_column('message_classifier_scoredmessage', 'action', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ScoredMessage.action'
        raise RuntimeError("Cannot reverse this migration. 'ScoredMessage.action' and its values cannot be restored.")
    models = {
        'auth.group': {
