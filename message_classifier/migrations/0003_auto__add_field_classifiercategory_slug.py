...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassifierCategory.slug'
        db.add_column('message_classifier_classifiercategory', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ClassifierCategory.slug'
        db.delete_column('message_classifier_classifiercategory', 'slug')
