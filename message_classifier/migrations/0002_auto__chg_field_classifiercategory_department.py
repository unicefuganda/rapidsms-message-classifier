...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClassifierCategory.department'
        db.alter_column('message_classifier_classifiercategory', 'department_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['message_classifier.Department'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ClassifierCategory.department'
        raise RuntimeError("Cannot reverse this migration. 'ClassifierCategory.department' and its values cannot be restored.")
