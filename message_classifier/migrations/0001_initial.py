...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            ...
            db.create_table('ibm_msg_category', (
                ('msg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms_httprouter.Message'], primary_key=True)),
                ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['message_classifier.IbmCategory'])),
    ...
    models = {
        ...
        'message_classifier.ibmmsgcategory': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['message_classifier.IbmCategory']"}),
            'msg': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rapidsms_httprouter.Message']", 'primary_key': 'True'}),
